...
void Interface :: atomic_fetch_and_add( memslot_t srcSlot, size_t srcOffset,
		pid_t dstPid, memslot_t dstSlot, size_t dstOffset, 
		uint64_t value )
{
	m_mesgQueue.atomic_fetch_and_add( srcSlot, srcOffset,
			dstPid, dstSlot, dstOffset, 
			value );
}

void Interface :: atomic_cmp_and_swp( memslot_t srcSlot, size_t srcOffset,
		pid_t dstPid, memslot_t dstSlot, size_t dstOffset, 
		uint64_t cmp, uint64_t swp )
{
	m_mesgQueue.atomic_cmp_and_swp( srcSlot, srcOffset,
			dstPid, dstSlot, dstOffset, 
			cmp, swp );
}
