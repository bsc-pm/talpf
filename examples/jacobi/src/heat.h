...
int initialize(HeatConfiguration *conf, int64_t rows, int64_t cols, int64_t rowOffset);
...
void computeBlock(const int64_t rows, const int64_t cols, const int rstart, const int rend, const int cstart, const int cend, const double srcM[rows][cols], double dstM[rows][cols]);
double computeBlockResidual(const int64_t rows, const int64_t cols, const int rstart, const int rend, const int cstart, const int cend, const double srcM[rows][cols], double dstM[rows][cols]);
